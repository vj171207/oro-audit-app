// api/active-loans.js
// Returns all currently active loans from Tenmark Prod (Metabase)
// The app then subtracts already-audited loans to show only unaudited ones
...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({ loans, fetchedAt: new Date().toISOString() });
