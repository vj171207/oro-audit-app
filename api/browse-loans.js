...
export default async function handler(req, res) {
  ...
  // Strictly validate date format before it ever reaches the SQL string.
  // Prevents SQL injection via the from/to query params — the app itself
  // only ever sends YYYY-MM-DD, so this rejects nothing the UI legitimately sends.
